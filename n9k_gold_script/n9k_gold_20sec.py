...
while True:
	...
	cli('diagnostic start module 22 test 1 ; diagnostic start module 23 test 1 ;\
	 diagnostic start module 24 test 1 ; diagnostic start module 26 test 1 ')

	time.sleep (20)

# GOLD Interval Change
# [MOD]ASICRegisterCheck(test1): 1min. => 20 sec.
# [FM]ASICRegisterCheck(test1): 1min. => 20 sec.
